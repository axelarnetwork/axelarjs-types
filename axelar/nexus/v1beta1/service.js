...
class MsgServiceClientImpl {
    ...
    EnableLinkDeposit(request) {
        const data = tx_1.EnableLinkDepositRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "EnableLinkDeposit", data);
        return promise.then((data) => tx_1.EnableLinkDepositResponse.decode(minimal_1.default.Reader.create(data)));
    }
    DisableLinkDeposit(request) {
        const data = tx_1.DisableLinkDepositRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "DisableLinkDeposit", data);
        return promise.then((data) => tx_1.DisableLinkDepositResponse.decode(minimal_1.default.Reader.create(data)));
    }
...
class QueryServiceClientImpl {
    ...
    LinkDepositEnabled(request) {
        const data = query_1.LinkDepositEnabledRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "LinkDepositEnabled", data);
        return promise.then((data) => query_1.LinkDepositEnabledResponse.decode(minimal_1.default.Reader.create(data)));
    }
}
