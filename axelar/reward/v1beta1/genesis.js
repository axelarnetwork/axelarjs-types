...
exports.GenesisState = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.pools) {
            types_1.Pool.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        ...
        if ((_a = message.pools) === null || _a === void 0 ? void 0 : _a.length) {
            obj.pools = message.pools.map((e) => types_1.Pool.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.pools = ((_a = object.pools) === null || _a === void 0 ? void 0 : _a.map((e) => types_1.Pool.fromPartial(e))) || [];
        return message;
    },
};
