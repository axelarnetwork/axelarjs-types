...
const tx_1 = require("../../../axelar/snapshot/v1beta1/tx");
const query_1 = require("../../../axelar/snapshot/v1beta1/query");
...
class MsgServiceClientImpl {
    ...
    RegisterProxy(request) {
        ...
        return promise.then((data) => tx_1.RegisterProxyResponse.decode(new _m0.Reader(data)));
    }
    DeactivateProxy(request) {
        ...
        return promise.then((data) => tx_1.DeactivateProxyResponse.decode(new _m0.Reader(data)));
    }
}
