...
exports.RegisterExternalKeysRequest = {
    ...
    fromPartial(object) {
        ...
        message.externalKeys =
            ((_b = object.externalKeys) === null || _b === void 0 ? void 0 : _b.map((e) => exports.RegisterExternalKeysRequest_ExternalKey.fromPartial(e))) || [];
...
exports.SubmitMultisigPubKeysRequest = {
    ...
    fromPartial(object) {
        ...
        message.sigKeyPairs = ((_b = object.sigKeyPairs) === null || _b === void 0 ? void 0 : _b.map((e) => types_2.SigKeyPair.fromPartial(e))) || [];
        message.sender = (_c = object.sender) !== null && _c !== void 0 ? _c : "";
        return message;
    },
};
