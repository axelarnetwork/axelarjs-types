    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 3:
          ...
          message.chains.push(GenesisState_Chain.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const GenesisState_Chain = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.confirmedDeposits.push(ERC20Deposit.decode(reader, reader.uint32()));
          continue;
        case 5:
          if (tag !== 42) {
            break;
          ...
          message.burnedDeposits.push(ERC20Deposit.decode(reader, reader.uint32()));
          continue;
        case 8:
          if (tag !== 66) {
            break;
          ...
          message.commandBatches.push(CommandBatchMetadata.decode(reader, reader.uint32()));
          continue;
        case 9:
          if (tag !== 74) {
            break;
        ...
        case 10:
          ...
          message.tokens.push(ERC20TokenMetadata.decode(reader, reader.uint32()));
          continue;
        case 11:
          if (tag !== 90) {
            break;
  ...
  toJSON(message: GenesisState_Chain): unknown {
    ...
    if (message.confirmedDeposits?.length) {
      obj.confirmedDeposits = message.confirmedDeposits.map((e) => ERC20Deposit.toJSON(e));
    }
    if (message.burnedDeposits?.length) {
      obj.burnedDeposits = message.burnedDeposits.map((e) => ERC20Deposit.toJSON(e));
    }
    if (message.commandBatches?.length) {
      obj.commandBatches = message.commandBatches.map((e) => CommandBatchMetadata.toJSON(e));
    }
    if (message.gateway !== undefined) {
    ...
    if (message.legacyConfirmedDeposits?.length) {
      obj.legacyConfirmedDeposits = message.legacyConfirmedDeposits.map((e) => ERC20Deposit.toJSON(e));
    }
    if (message.legacyBurnedDeposits?.length) {
      obj.legacyBurnedDeposits = message.legacyBurnedDeposits.map((e) => ERC20Deposit.toJSON(e));
    }
    return obj;
  },
