...
export class MsgServiceClientImpl implements MsgService {
  ...
  SetGateway(request: SetGatewayRequest): Promise<SetGatewayResponse> {
    ...
    return promise.then((data) => SetGatewayResponse.decode(_m0.Reader.create(data)));
  }
  ...
  ConfirmGatewayTx(request: ConfirmGatewayTxRequest): Promise<ConfirmGatewayTxResponse> {
    ...
    return promise.then((data) => ConfirmGatewayTxResponse.decode(_m0.Reader.create(data)));
  }
  ...
  ConfirmGatewayTxs(request: ConfirmGatewayTxsRequest): Promise<ConfirmGatewayTxsResponse> {
    ...
    return promise.then((data) => ConfirmGatewayTxsResponse.decode(_m0.Reader.create(data)));
  }
  ...
  ConfirmToken(request: ConfirmTokenRequest): Promise<ConfirmTokenResponse> {
    ...
    return promise.then((data) => ConfirmTokenResponse.decode(_m0.Reader.create(data)));
  }

  ConfirmDeposit(request: ConfirmDepositRequest): Promise<ConfirmDepositResponse> {
    const data = ConfirmDepositRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ConfirmDeposit", data);
    return promise.then((data) => ConfirmDepositResponse.decode(_m0.Reader.create(data)));
  }
  ...
  ConfirmTransferKey(request: ConfirmTransferKeyRequest): Promise<ConfirmTransferKeyResponse> {
    ...
    return promise.then((data) => ConfirmTransferKeyResponse.decode(_m0.Reader.create(data)));
  }
  ...
  CreateDeployToken(request: CreateDeployTokenRequest): Promise<CreateDeployTokenResponse> {
    ...
    return promise.then((data) => CreateDeployTokenResponse.decode(_m0.Reader.create(data)));
  }
  ...
  CreateBurnTokens(request: CreateBurnTokensRequest): Promise<CreateBurnTokensResponse> {
    ...
    return promise.then((data) => CreateBurnTokensResponse.decode(_m0.Reader.create(data)));
  }
  ...
  CreatePendingTransfers(request: CreatePendingTransfersRequest): Promise<CreatePendingTransfersResponse> {
    ...
    return promise.then((data) => CreatePendingTransfersResponse.decode(_m0.Reader.create(data)));
  }
  ...
  CreateTransferOperatorship(
    ...
    return promise.then((data) => CreateTransferOperatorshipResponse.decode(_m0.Reader.create(data)));
  }

  SignCommands(request: SignCommandsRequest): Promise<SignCommandsResponse> {
    const data = SignCommandsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SignCommands", data);
    return promise.then((data) => SignCommandsResponse.decode(_m0.Reader.create(data)));
  }

  AddChain(request: AddChainRequest): Promise<AddChainResponse> {
    const data = AddChainRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "AddChain", data);
    return promise.then((data) => AddChainResponse.decode(_m0.Reader.create(data)));
  }
  ...
  RetryFailedEvent(request: RetryFailedEventRequest): Promise<RetryFailedEventResponse> {
    ...
    return promise.then((data) => RetryFailedEventResponse.decode(_m0.Reader.create(data)));
  }
...
export class QueryServiceClientImpl implements QueryService {
  ...
  BatchedCommands(request: BatchedCommandsRequest): Promise<BatchedCommandsResponse> {
    ...
    return promise.then((data) => BatchedCommandsResponse.decode(_m0.Reader.create(data)));
  }

  BurnerInfo(request: BurnerInfoRequest): Promise<BurnerInfoResponse> {
    const data = BurnerInfoRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "BurnerInfo", data);
    return promise.then((data) => BurnerInfoResponse.decode(_m0.Reader.create(data)));
  }
