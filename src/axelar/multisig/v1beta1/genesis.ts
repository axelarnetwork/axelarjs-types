...
export const GenesisState = {
  $type: "axelar.multisig.v1beta1.GenesisState" as const,
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.keygenSessions?.length) {
      obj.keygenSessions = message.keygenSessions.map((e) => KeygenSession.toJSON(e));
    }
    if (message.signingSessions?.length) {
      obj.signingSessions = message.signingSessions.map((e) => SigningSession.toJSON(e));
    }
