...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    if (message.chainActivationThreshold !== undefined) {
      obj.chainActivationThreshold = Threshold.toJSON(message.chainActivationThreshold);
    }
    if (message.chainMaintainerMissingVoteThreshold !== undefined) {
      obj.chainMaintainerMissingVoteThreshold = Threshold.toJSON(message.chainMaintainerMissingVoteThreshold);
    }
    if (message.chainMaintainerIncorrectVoteThreshold !== undefined) {
