...
function createBaseLinkDepositEnabledRequest(): LinkDepositEnabledRequest {
  return { $type: "axelar.nexus.v1beta1.LinkDepositEnabledRequest" };
}

export const LinkDepositEnabledRequest = {
  $type: "axelar.nexus.v1beta1.LinkDepositEnabledRequest" as const,
  ...
  fromJSON(_: any): LinkDepositEnabledRequest {
    return { $type: LinkDepositEnabledRequest.$type };
  },
  ...
  create<I extends Exact<DeepPartial<LinkDepositEnabledRequest>, I>>(base?: I): LinkDepositEnabledRequest {
    return LinkDepositEnabledRequest.fromPartial(base ?? ({} as any));
  },
...
messageTypeRegistry.set(LinkDepositEnabledRequest.$type, LinkDepositEnabledRequest);

function createBaseLinkDepositEnabledResponse(): LinkDepositEnabledResponse {
  return { $type: "axelar.nexus.v1beta1.LinkDepositEnabledResponse", enabled: false };
}

export const LinkDepositEnabledResponse = {
  $type: "axelar.nexus.v1beta1.LinkDepositEnabledResponse" as const,
  ...
  fromJSON(object: any): LinkDepositEnabledResponse {
    return {
      $type: LinkDepositEnabledResponse.$type,
  ...
  create<I extends Exact<DeepPartial<LinkDepositEnabledResponse>, I>>(base?: I): LinkDepositEnabledResponse {
    return LinkDepositEnabledResponse.fromPartial(base ?? ({} as any));
  },
...
messageTypeRegistry.set(LinkDepositEnabledResponse.$type, LinkDepositEnabledResponse);
