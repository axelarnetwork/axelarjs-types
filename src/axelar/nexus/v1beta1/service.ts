...
export class MsgServiceClientImpl implements MsgService {
  ...
  RegisterChainMaintainer(request: RegisterChainMaintainerRequest): Promise<RegisterChainMaintainerResponse> {
    ...
    return promise.then((data) => RegisterChainMaintainerResponse.decode(_m0.Reader.create(data)));
  }
  ...
  DeregisterChainMaintainer(
    ...
    return promise.then((data) => DeregisterChainMaintainerResponse.decode(_m0.Reader.create(data)));
  }

  ActivateChain(request: ActivateChainRequest): Promise<ActivateChainResponse> {
    const data = ActivateChainRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ActivateChain", data);
    return promise.then((data) => ActivateChainResponse.decode(_m0.Reader.create(data)));
  }

  DeactivateChain(request: DeactivateChainRequest): Promise<DeactivateChainResponse> {
    const data = DeactivateChainRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeactivateChain", data);
    return promise.then((data) => DeactivateChainResponse.decode(_m0.Reader.create(data)));
  }
  ...
  RegisterAssetFee(request: RegisterAssetFeeRequest): Promise<RegisterAssetFeeResponse> {
    ...
    return promise.then((data) => RegisterAssetFeeResponse.decode(_m0.Reader.create(data)));
  }
  ...
  EnableLinkDeposit(request: EnableLinkDepositRequest): Promise<EnableLinkDepositResponse> {
    ...
    return promise.then((data) => EnableLinkDepositResponse.decode(_m0.Reader.create(data)));
  }
  ...
  DisableLinkDeposit(request: DisableLinkDepositRequest): Promise<DisableLinkDepositResponse> {
    ...
    return promise.then((data) => DisableLinkDepositResponse.decode(_m0.Reader.create(data)));
  }
...
export class QueryServiceClientImpl implements QueryService {
  ...
  LatestDepositAddress(request: LatestDepositAddressRequest): Promise<LatestDepositAddressResponse> {
    ...
    return promise.then((data) => LatestDepositAddressResponse.decode(_m0.Reader.create(data)));
  }
  ...
  TransfersForChain(request: TransfersForChainRequest): Promise<TransfersForChainResponse> {
    ...
    return promise.then((data) => TransfersForChainResponse.decode(_m0.Reader.create(data)));
  }

  FeeInfo(request: FeeInfoRequest): Promise<FeeInfoResponse> {
    const data = FeeInfoRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "FeeInfo", data);
    return promise.then((data) => FeeInfoResponse.decode(_m0.Reader.create(data)));
  }

  TransferFee(request: TransferFeeRequest): Promise<TransferFeeResponse> {
    const data = TransferFeeRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "TransferFee", data);
    return promise.then((data) => TransferFeeResponse.decode(_m0.Reader.create(data)));
  }
  ...
  RecipientAddress(request: RecipientAddressRequest): Promise<RecipientAddressResponse> {
    ...
    return promise.then((data) => RecipientAddressResponse.decode(_m0.Reader.create(data)));
  }
  ...
  ChainMaintainers(request: ChainMaintainersRequest): Promise<ChainMaintainersResponse> {
    ...
    return promise.then((data) => ChainMaintainersResponse.decode(_m0.Reader.create(data)));
  }
  ...
  TransferRateLimit(request: TransferRateLimitRequest): Promise<TransferRateLimitResponse> {
    ...
    return promise.then((data) => TransferRateLimitResponse.decode(_m0.Reader.create(data)));
  }

  Message(request: MessageRequest): Promise<MessageResponse> {
    const data = MessageRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "Message", data);
    return promise.then((data) => MessageResponse.decode(_m0.Reader.create(data)));
  }
  ...
  LinkDepositEnabled(request: LinkDepositEnabledRequest): Promise<LinkDepositEnabledResponse> {
    ...
    return promise.then((data) => LinkDepositEnabledResponse.decode(_m0.Reader.create(data)));
  }
}
