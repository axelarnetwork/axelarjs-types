...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.keyRequirements.push(KeyRequirement.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 16) {
            break;
        ...
        case 4:
          ...
          message.maxMissedBlocksPerWindow = Threshold.decode(reader, reader.uint32());
          continue;
        case 5:
          if (tag !== 40) {
            break;
        ...
        case 6:
          ...
          message.externalMultisigThreshold = Threshold.decode(reader, reader.uint32());
          continue;
        case 7:
          if (tag !== 56) {
            break;
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.keyRequirements?.length) {
      obj.keyRequirements = message.keyRequirements.map((e) => KeyRequirement.toJSON(e));
    }
    if (!message.suspendDurationInBlocks.equals(Long.ZERO)) {
      obj.suspendDurationInBlocks = (message.suspendDurationInBlocks || Long.ZERO).toString();
    }
    if (!message.heartbeatPeriodInBlocks.equals(Long.ZERO)) {
      obj.heartbeatPeriodInBlocks = (message.heartbeatPeriodInBlocks || Long.ZERO).toString();
    }
    if (message.maxMissedBlocksPerWindow !== undefined) {
      obj.maxMissedBlocksPerWindow = Threshold.toJSON(message.maxMissedBlocksPerWindow);
    }
    if (!message.unbondingLockingKeyRotationCount.equals(Long.ZERO)) {
    ...
    if (message.externalMultisigThreshold !== undefined) {
      obj.externalMultisigThreshold = Threshold.toJSON(message.externalMultisigThreshold);
    }
    if (!message.maxSignQueueSize.equals(Long.ZERO)) {
      obj.maxSignQueueSize = (message.maxSignQueueSize || Long.ZERO).toString();
    }
    if (!message.maxSimultaneousSignShares.equals(Long.ZERO)) {
      obj.maxSimultaneousSignShares = (message.maxSimultaneousSignShares || Long.ZERO).toString();
    }
    if (!message.tssSignedBlocksWindow.equals(Long.ZERO)) {
      obj.tssSignedBlocksWindow = (message.tssSignedBlocksWindow || Long.ZERO).toString();
    }
    return obj;
  },
